...
description: Complete reference for all 33 PubMed Search MCP tools. Triggers: 工具列表, all tools, 完整功能, tool reference, 有哪些工具
---

# PubMed Search MCP 工具完整參考

## 描述
所有 33 個 MCP 工具的完整參考，包含參數說明和使用範例。
...
*Total: 33 tools in 13 categories*
