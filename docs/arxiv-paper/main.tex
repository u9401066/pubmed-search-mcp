...
\begin{enumerate}
    \item \textbf{Multi-source integration architecture:} An MCP SDK v2 system exposing 41 tools over registry-selected biomedical, scholarly-graph, open-access, preprint, and optional licensed sources through a Domain-Driven Design architecture (Section~\ref{sec:architecture}).
...
+-----------------------------------------------------------+
                   ...
                   MCP Protocol (JSON-RPC)
                          |
+-----------------------------------------------------------+
| Presentation Layer: 41 MCP Tools, 9 Prompts, Resources    |
+-----------------------------------------------------------+
| Application Layer                                         |
...
The system exposes 41 MCP tools organized into 16 registry categories (Table~\ref{tab:tools}).
...
With 41 MCP tools, 3{,}700+ automated tests, and a registry-backed multi-source broker, \system{} demonstrates that the gap between literature \emph{search} and literature \emph{understanding} can be bridged through principled algorithms and thoughtful system design.
