...
**📘 Tool Usage Docs**: [Capability-first guide](TOOLS_USAGE_GUIDE.md) | [Complete index](#/quick-reference)
...
Start with the [Tools Usage Guide](TOOLS_USAGE_GUIDE.md): it compresses the current 40 tools into 8 capability families, explains the theoretical lower bound, and gives intent-based routing for both humans and agents.
