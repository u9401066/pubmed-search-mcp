...
def _write_text_crlf(path: Path, content: str) -> None:
    """Write generated docs files using repo-friendly CRLF line endings on Windows."""
...
def build_site() -> None:
    ...
    for slug, title, source_path in PAGES:
        ...
        _write_text_crlf(output_path, rendered)
