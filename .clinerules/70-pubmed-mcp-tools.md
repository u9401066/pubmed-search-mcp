...
- For clinical comparison questions, extract P/I/C/O in the agent, then use `validate_pico_plan` to validate the structured handoff and obtain a runnable PICO pipeline.
