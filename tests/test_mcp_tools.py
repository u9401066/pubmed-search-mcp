...
class TestCommonTools:
    ...
    def test_set_session_manager(self):
        ...
        from pubmed_search.mcp.tools._common import set_session_manager, _session_manager
    ...
    def test_set_strategy_generator(self):
        ...
        from pubmed_search.mcp.tools._common import set_strategy_generator, get_strategy_generator
...
class TestStrategyTools:
    ...
    def test_strategy_module_exists(self):
        ...
        from pubmed_search.mcp.tools import strategy
...
class TestMergeTools:
    ...
    def test_merge_module_exists(self):
        ...
        from pubmed_search.mcp.tools import merge
