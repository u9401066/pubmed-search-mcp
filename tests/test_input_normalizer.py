...
class TestInputNormalizerPMIDs:
    ...
    def test_single_pmid_string(self):
        ...
        from pubmed_search.mcp_server.tools._common import InputNormalizer
...
class TestResponseFormatter:
    ...
    def test_success_markdown(self):
        ...
        from pubmed_search.mcp_server.tools._common import ResponseFormatter
...
class TestKeyAliases:
    ...
    def test_year_aliases(self):
        ...
        from pubmed_search.mcp_server.tools._common import apply_key_aliases
