...
class TestConfiguration:
    ...
    async def test_configure_proxy_from_env(self):
    ...
    async def test_configure_proxy_explicit_overrides_env(self):
    ...
    async def test_configure_client_partial(self):
...
class TestRateLimiting:
    ...
    async def test_rate_limit_creates_entry(self):
...
class TestHttpGet:
    ...
    async def test_http_get_success_json(self, mock_build_opener):
    ...
    @patch("pubmed_search.infrastructure.http.client._build_opener")
    async def test_http_get_success_text(self, mock_build_opener):
    ...
    @patch("pubmed_search.infrastructure.http.client._build_opener")
    async def test_http_get_rate_limit_error(self, mock_build_opener):
    ...
    @patch("pubmed_search.infrastructure.http.client._build_opener")
    async def test_http_get_url_error(self, mock_build_opener):
    ...
    @patch("pubmed_search.infrastructure.http.client._build_opener")
    async def test_http_get_json_decode_error(self, mock_build_opener):
...
class TestHttpGetSafe:
    ...
    async def test_http_get_safe_success(self, mock_http_get):
    ...
    @patch("pubmed_search.infrastructure.http.client.http_get")
    async def test_http_get_safe_error_returns_none(self, mock_http_get):
...
class TestHttpPost:
    ...
    @patch("pubmed_search.infrastructure.http.client._build_opener")
    async def test_http_post_json_data(self, mock_build_opener):
    ...
    @patch("pubmed_search.infrastructure.http.client._build_opener")
    async def test_http_post_form_data(self, mock_build_opener):
    ...
    @patch("pubmed_search.infrastructure.http.client._build_opener")
    async def test_http_post_no_data(self, mock_build_opener):
    ...
    @patch("pubmed_search.infrastructure.http.client._build_opener")
    async def test_http_post_rate_limit_error(self, mock_build_opener):
...
class TestHttpPostSafe:
    ...
    async def test_http_post_safe_success(self, mock_http_post):
    ...
    @patch("pubmed_search.infrastructure.http.client.http_post")
    async def test_http_post_safe_error_returns_none(self, mock_http_post):
...
class TestWithRetry:
    ...
    async def test_retry_rate_limit_honors_retry_after(self):
    ...
    async def test_retry_service_unavailable(self):
...
class TestHelperFunctions:
    ...
    async def test_build_opener_no_proxy(self):
    ...
    async def test_build_opener_with_proxy(self):
