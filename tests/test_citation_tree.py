...
from pubmed_search.mcp.tools.citation_tree import (
...
def test_format_converters():
    ...
    nodes = [
        ...
        _make_node({**sample_article, "pmid": "87654321", "title": "Citing Paper"}, level=1, direction="citing"),
        _make_node({**sample_article, "pmid": "11111111", "title": "Reference Paper"}, level=1, direction="reference"),
    ]
    edges = [
...
def test_full_tree():
    ...
    from pubmed_search.mcp.tools.citation_tree import _make_node, _make_edge
