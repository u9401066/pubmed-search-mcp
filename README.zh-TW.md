...
目前 timeline 與 tree 是 projection，不是持久化 chronicle asset。下一輪規劃中的持久化、版本化 Research Chronicle 規格請見 [docs/RESEARCH_CHRONICLE_REFACTOR_SPEC.md](docs/RESEARCH_CHRONICLE_REFACTOR_SPEC.md)。
